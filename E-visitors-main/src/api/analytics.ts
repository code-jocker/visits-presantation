...
export const analyticsApi = {
   ...
   */
  getSystemHealth: async (): Promise<{ success: boolean; result: unknown }> => {
   ...
   */
  getTopVisitors: async (limit?: number): Promise<{ success: boolean; result: unknown[] }> => {
   ...
   */
  getActiveSessions: async (): Promise<{ success: boolean; result: unknown[] }> => {
