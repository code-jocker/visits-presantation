...
interface AddCustomerProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (customerData: Record<string, unknown>) => void;
}
...
function AddCustomer({ isOpen, onClose, onSubmit }: AddCustomerProps) {
  ...
  const [villages, setVillages] = useState<unknown[]>([]);

  const toTextArray = (arr: unknown[]) => arr.map((x) => String(x));
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {toTextArray(provinces).map((province, index) => (
                  ...
                  <div>
                    ...
                    >
                      ...
                      {toTextArray(districts).map((district, index) => (
                  ...
                  <div>
                    ...
                    >
                      ...
                      {toTextArray(sectors).map((sector, index) => (
                  ...
                  <div>
                    ...
                    >
                      ...
                      {toTextArray(cells).map((cell, index) => (
                  ...
                  <div>
                    ...
                    >
                      ...
                      {toTextArray(villages).map((village, index) => (
