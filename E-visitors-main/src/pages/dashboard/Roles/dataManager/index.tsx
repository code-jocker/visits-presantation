...
function DataManagerDashboard() {
    ...
    const recentActivities = [
        { id: 1, action: 'Data Export', user: 'Admin', time: '2 mins ago', type: 'export' },
        { id: 2, action: 'Data Import', user: 'Manager', time: '15 mins ago', type: 'import' },
        { id: 3, action: 'Report Generated', user: 'Admin', time: '1 hour ago', type: 'report' },
    ]
